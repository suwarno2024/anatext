...
# --- MODAL STOPWORDS (UPDATED @st.dialog) ---
# Menggunakan @st.dialog (stabil di versi 1.35+)
...
if st.session_state.analysis_done and st.session_state.data is not None:
    ...
    with tab_ngram:
        ...
        with col_bi:
            ...
            else: st.info("Data tidak cukup untuk Bigram.")
        ...
        with col_tri:
            ...
            else: st.info("Data tidak cukup untuk Trigram.")
    ...
    with tab_ner:
        ...
        with col_n1: plot_ner_category(ner_data['Person'], "Person (Orang)", "#3b82f6")
        with col_n2: plot_ner_category(ner_data['Organization'], "Organization (Instansi)", "#ef4444")
        with col_n3: plot_ner_category(ner_data['Location'], "Location (Lokasi)", "#10b981")
